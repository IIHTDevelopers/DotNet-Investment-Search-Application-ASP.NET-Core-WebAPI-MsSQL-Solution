...
namespace InvestmentSearchApplication.Tests.TestCases
{
    public class BoundaryTests
    {
        ...
        [Fact]
        public async Task<bool> Testfor_Email_NotEmpty()
        {
            //Arrange
            bool res = false;
            ...
            try
            {
                ...
                var actualLength = _UserView.Email.ToString().Length;
                if (_UserView.Email.ToString().Length == actualLength)
                {
                    res = true;
                }
            }
        ...
        [Fact]
        public async Task<bool> Testfor_Password_NotEmpty()
        {
            //Arrange
            bool res = false;
            string testName; string status;
            ...
            try
            {
                investmentsearch.Setup(repo => repo.UserLogin(_UserView)).ReturnsAsync(true);
                var result = await _investmentSearch.UserLogin(_UserView);
                var actualLength = _UserView.Password.ToString().Length;
                if (_UserView.Password.ToString().Length == actualLength)
                {
                    res = true;
                }
            }
        ...
        [Fact]
        public async Task<bool> Testfor_StockId_NotEmpty()
        {
            //Arrange
            bool res = false;
            string testName; string status;
            ...
            try
            {
                ...
                var actualLength = _Stock.Id.ToString().Length;
                if(_Stock.Id.ToString().Length == actualLength)
                {
                    res = true;
                }
            }
        ...
        [Fact]
        public async Task<bool> Testfor_StockName_NotEmpty()
        {
            //Arrange
            bool res = false;
            string testName; string status;
            ...
            try
            {
                investmentsearch.Setup(repo => repo.SearchStock(_Stock.Name)).ReturnsAsync(_StockList);
                var result = await _investmentSearch.SearchStock(_Stock.Name);
                var actualLength = _Stock.Name.ToString().Length;
                if (_Stock.Name.ToString().Length == actualLength)
                {
                    res = true;
                }
            }
        ...
        [Fact]
        public async Task<bool> Testfor_StockDebt_NotEmpty()
        {
            //Arrange
            bool res = false;
            string testName; string status;
            ...
            try
            {
                investmentsearch.Setup(repo => repo.SearchStock(_Stock.Name)).ReturnsAsync(_StockList);
                var result = await _investmentSearch.SearchStock(_Stock.Name);
                var actualLength = _Stock.Debt.ToString().Length;
                if (_Stock.Debt.ToString().Length == actualLength)
                {
                    res = true;
                }
            }
        ...
        [Fact]
        public async Task<bool> Testfor_StockCash_NotEmpty()
        {
            //Arrange
            bool res = false;
            string testName; string status;
            ...
            try
            {
                investmentsearch.Setup(repo => repo.SearchStock(_Stock.Name)).ReturnsAsync(_StockList);
                var result = await _investmentSearch.SearchStock(_Stock.Name);
                var actualLength = _Stock.Cash.ToString().Length;
                if (_Stock.Cash.ToString().Length == actualLength)
                {
                    res = true;
                }
            }
