...
namespace InvestmentSearchApplication.Tests.TestCases
{
    public class ExceptionalTests
    {
        ...
        [Fact]
        public async Task<bool> Testfor_Validate_IfInvalidEmailIdIsPassed()
        {
            //Arrange
            bool res = false;
            ...
            try
            {
                ...
                if (result != null || _UserView.Email != null)
                {
                    res = true;
                }
            }
        ...
        [Fact]
        public async Task<bool> Testfor_Validate_IfInvalidStockIdIsPassed()
        {
            //Arrange
            bool res = false;
            string testName; string status;
        ...
        [Fact]
        public async Task<bool> Testfor_Validate_IfInvalidStockNumberIsPassed()
        {
            //Arrange
            bool res = false;
            string testName; string status;
            ...
            try
            {
                ...
                if (result != null || actualLength != null)
                {
                    res = true;
                }
            }
        ...
        [Fact]
        public async Task<bool> Testfor_Validate_IfInvalidStockDebtIsPassed()
        {
            //Arrange
            bool res = false;
            string testName; string status;
        ...
        [Fact]
        public async Task<bool> Testfor_Validate_IfInvalidStockCashIsPassed()
        {
            //Arrange
            bool res = false;
            string testName; string status;
